# ComplyFood User Guide

## Admin
- Sign in and maintain the organization profile
- Add locations and manage user roles
...
2. Open **Daily Logs** to create or update entries
